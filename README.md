...
| Stream Analytics Jobs | Streaming Data | [Global data distribution](https://github.com/davedoesdemos/globaldatareplication) | [No Video Yet](https://youtu.be/3khzPbmHbAQ) | This demo shows how to use Stream Analytics to distribute data from Event Hubs into SQL Servers globally with minimal latency using the CSV function app as a source |
